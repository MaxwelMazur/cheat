...
func (self *GameProcess) MapsPath() string {
	return self.ProcPrefix("maps")
}

func (self *GameProcess) ExePath() string {
	return self.ProcPrefix("exe")
}
...
func (self *GameProcess) ParseMaps() (maps Mapping, err error) {
	...
	for s.Scan() {
		...
		// TODO: previnir o range não alcançavel
		m.Path = string(parts[5])
